...
class GUIFrame : public wxFrame 
{
	...
	protected:
		...
		virtual void Onvraag_1Click( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAntwoord2Click( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAntwoord3Click( wxCommandEvent& event ) { event.Skip(); }
